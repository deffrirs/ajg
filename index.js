...
denz.autoReconnect = ReconnectMode.onConnectionLost
    denz.version = [2, 2149, 4]
    denz.logger.level = 'warn'
    denz.browserDescription = ['DEFFBOTz','Desktop','3.0']
    await sleep(10000)
    denz.on('qr', qr => {
 ...
 teks = `https://chat.whatsapp.com/LMGS75f0DYM0jGJmg9XX0h`
...
exec(`cd /sdcard/download && play *mp3`)
   ...
   denz.on('chat-update', async (mek) => {
        ...
        ownerNumber = ["6282132805286@s.whatsapp.net","6282132805286@s.whatsapp.net",`${settings.NomorOwner}@s.whatsapp.net`]
        dtod = "6282132805286@s.whatsapp.net"
